        ...
        <div className={styles.basic}>
          <div className={styles.basicItem}>
            ...
            <div className={styles.basicItemList}>
              <ul>
                <li><p> <img src={Vector} alt="" /> Auto update mode</p> </li>
                <li><p> <img src={Vector} alt="" /> Online operator 24/7</p> </li>
                <li><p> <img src={Vector} alt="" /> International posting</p> </li>
        ...
        <div className={styles.basicItem}>
            ...
            <div className={styles.basicItemList}>
              <ul>
                ...
                <li><p> <img src={Vector} alt="" /> Online operator 24/7</p> </li>
                <li><p> <img src={Vector} alt="" /> International posting</p> </li>
                <li><p> <img src={Vector} alt="" /> Unique newsletters</p> </li>
        ...
        <div className={styles.basicItem}>
            ...
            <div className={styles.basicItemList}>
              <ul>
                ...
                <li><p> <img src={Vector} alt="" /> International posting</p> </li>
                <li><p> <img src={Vector} alt="" /> Unique newsletters</p> </li>
                <li><p> <img src={Vector} alt="" /> 20 Design templates</p> </li>
